                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mt-2">
                                ...
                                <div class="border p-4 rounded dark:border-gray-700">
                                    ...
                                    <div class="flex items-center mb-2">
                                        <input id="permission_{{ $permission->id }}" type="checkbox" name="permissions[]" value="{{ $permission->id }}" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" {{ in_array($permission->id, old('permissions', $rolePermissions)) ? 'checked' : '' }}>
